...
graph TB
    subgraph Before["Before Incident - Single Points of Failure"]
        subgraph EdgeBefore["Edge Plane #0066CC"]
            LoadBalancer["AWS Load Balancer<br/>Single instance"]
        end

        subgraph ServiceBefore["Service Plane #00AA00"]
            S3API["S3 API Service<br/>Dependent on index"]
        end

        subgraph StateBefore["State Plane #FF8800"]
        ...
        subgraph ControlBefore["Control Plane #CC0000"]
    ...
    subgraph After["After Incident - Redundant 4-Plane Architecture"]
        subgraph EdgeAfter["Edge Plane #0066CC"]
            LoadBalancerNew["AWS ALB<br/>Multi-AZ redundant"]
        end

        subgraph ServiceAfter["Service Plane #00AA00"]
            S3APINew["S3 API Service<br/>Resilient design"]
        end

        subgraph StateAfter["State Plane #FF8800"]
        ...
        subgraph ControlAfter["Control Plane #CC0000"]
