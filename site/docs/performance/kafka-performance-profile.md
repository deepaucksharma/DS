...
```mermaid
graph TB
    subgraph sg_3_Partition_Topic[3 Partition Topic]
    ...
    subgraph sg_12_Partition_Topic[12 Partition Topic]
...
```mermaid
graph LR
    subgraph Under_partitioned__3_partitions[Under-partitioned (3 partitions)]
    ...
    subgraph Optimal_partitioned__30_partitions[Optimal partitioned (30 partitions)]
    ...
    subgraph Over_partitioned__300_partitions[Over-partitioned (300 partitions)]
...
```mermaid
graph TB
    subgraph Round_Robin_Partitioning[Round-Robin Partitioning]
    ...
    subgraph Key_Based_Partitioning[Key-Based Partitioning]
    ...
    subgraph Custom_Partitioning[Custom Partitioning]
...
```mermaid
graph TB
    subgraph Small_Batches__1KB[Small Batches (1KB)]
    ...
    subgraph Medium_Batches__16KB[Medium Batches (16KB)]
    ...
    subgraph Large_Batches__1MB[Large Batches (1MB)]
...
```mermaid
graph LR
    subgraph Low_Latency_Configuration[Low Latency Configuration]
    ...
    subgraph High_Throughput_Configuration[High Throughput Configuration]
    ...
    subgraph Balanced_Configuration[Balanced Configuration]
...
```mermaid
graph TB
    subgraph Healthy_Consumer_Group[Healthy Consumer Group]
    ...
    subgraph Lagging_Consumer_Group[Lagging Consumer Group]
...
graph TB
    ...
    subgraph Configuration_Tuning[Configuration Tuning]
    ...
    subgraph Application_Optimization[Application Optimization]
...
graph TB
    ...
    subgraph Snappy_Compression[Snappy Compression]
    ...
    subgraph LZ4_Compression[LZ4 Compression]
    ...
    subgraph GZIP_Compression[GZIP Compression]
...
```mermaid
graph LR
    subgraph High_Throughput___Low_Latency[High Throughput / Low Latency]
    ...
    subgraph Network_Constrained[Network Constrained]
    ...
    subgraph CPU_Constrained[CPU Constrained]
    ...
    subgraph Balanced_Workload[Balanced Workload]
...
```mermaid
graph TB
    subgraph LinkedIn_Kafka_Deployment[LinkedIn Kafka Deployment]
        subgraph Multiple_Data_Centers[Multiple Data Centers]
        ...
        subgraph Cross_DC_Replication[Cross-DC Replication]
...
```mermaid
graph TB
    subgraph Broker_Configuration[Broker Configuration]
    ...
    subgraph Hardware_Specification[Hardware Specification]
...
```mermaid
graph LR
    subgraph Growth_Phases[Growth Phases]
...
```mermaid
graph TB
    subgraph Level_1__Configuration[Level 1: Configuration]
        L1[Producer batching<br/>Consumer fetch sizing<br/>Compression selection<br/>JVM tuning]
    end

    subgraph Level_2__Architecture[Level 2: Architecture]
    ...
    subgraph Level_4__Application[Level 4: Application]
