...
graph TB
    subgraph Global_Failure_Domains[Global Failure Domains]
        ...
        subgraph Tier_2__Pod_Failures__F59E0B[Tier 2: Pod Failures #F59E0B]
        ...
        subgraph Tier_3__Service_Failures__FFCC00[Tier 3: Service Failures #FFCC00]
        ...
        subgraph Tier_4__Infrastructure_Failures__FFFF99[Tier 4: Infrastructure Failures #FFFF99]
...
```mermaid
graph TB
    subgraph Black_Friday_2019_Flash_Sale_Incident[Black Friday 2019 Flash Sale Incident]
        ...
        subgraph Impact_Assessment[Impact Assessment]
...
```mermaid
graph TB
    subgraph Database_Shard_Outage___March_2021[Database Shard Outage - March 2021]
        ...
        subgraph Technical_Details[Technical Details]
        ...
        subgraph Resolution_Metrics[Resolution Metrics]
...
```mermaid
graph TB
    subgraph Pod_Based_Merchant_Isolation[Pod-Based Merchant Isolation]
        subgraph Pod_Failure_Scenarios[Pod Failure Scenarios]
        ...
        subgraph Isolation_Mechanisms[Isolation Mechanisms]
        ...
        subgraph Failover_Procedures[Failover Procedures]
...
```mermaid
graph TB
    subgraph Service_Fallback_Strategies[Service Fallback Strategies]
        subgraph Storefront_Fallbacks[Storefront Fallbacks]
        ...
        subgraph Checkout_Fallbacks[Checkout Fallbacks]
        ...
        subgraph Admin_Fallbacks[Admin Fallbacks]
...
```mermaid
graph TB
    subgraph Geographic_Failure_Isolation[Geographic Failure Isolation]
        ...
        subgraph Cross_Region_Failover[Cross-Region Failover]
...
```mermaid
graph TB
    subgraph Black_Friday_Failure_Preparation[Black Friday Failure Preparation]
    ...
    subgraph Success_Metrics_2023[Success Metrics 2023]
