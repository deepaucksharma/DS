...
graph TB
    ...
    subgraph Infrastructure_Costs__F59E0B[Infrastructure Costs #F59E0B]
        subgraph Network_Costs__60[Network Costs (60%)]
        ...
        subgraph Hardware_Costs__25[Hardware Costs (25%)]
    ...
    subgraph Cost_Per_Service_Unit__3B82F6[Cost Per Service Unit #3B82F6]
...
```mermaid
graph TB
    subgraph Annual_Infrastructure_Spend___400M[Annual Infrastructure Spend: $400M+]
        subgraph Network_Infrastructure__65[Network Infrastructure (65%)]
        ...
        subgraph Compute_Infrastructure__25[Compute Infrastructure (25%)]
        ...
        subgraph Facility_Costs__10[Facility Costs (10%)]
...
```mermaid
graph LR
    subgraph Cost_Per_Request_Journey[Cost Per Request Journey]
...
```mermaid
graph TB
    subgraph Product_Economics[Product Economics]
        subgraph High_Margin__80[High Margin (80%+)]
        ...
        subgraph Medium_Margin__60_80[Medium Margin (60-80%)]
        ...
        subgraph Investment__40_60[Investment (40-60%)]
...
```mermaid
graph TB
    subgraph Server_Optimization[Server Optimization]
    ...
    subgraph Software_Optimization[Software Optimization]
...
```mermaid
graph TB
    subgraph Traffic_Engineering[Traffic Engineering]
    ...
    subgraph Capacity_Planning[Capacity Planning]
...
graph TB
    ...
    subgraph Operational_Metrics[Operational Metrics]
...
```mermaid
graph TB
    subgraph sg_2027_Cost_Projections[2027 Cost Projections]
    ...
    subgraph Investment_Areas[Investment Areas]
