...
graph TB
    ...
    subgraph Service_Plane___Operations_Services__10B981[Service Plane - Operations Services #10B981]
        subgraph Automation_Systems[Automation Systems]
        ...
        subgraph Testing___Validation[Testing & Validation]
    ...
    subgraph Edge_Plane___Global_Operations__3B82F6[Edge Plane - Global Operations #3B82F6]
        subgraph sg_285__PoPs_Worldwide[285+ PoPs Worldwide]
        ...
        subgraph Network_Operations[Network Operations]
    ...
    subgraph State_Plane___Operations_Data__F59E0B[State Plane - Operations Data #F59E0B]
        subgraph Metrics___Logs[Metrics & Logs]
        ...
        subgraph Configuration_Storage[Configuration Storage]
...
```mermaid
graph TB
    subgraph Quicksilver_Deployment_Pipeline[Quicksilver Deployment Pipeline]
    ...
    subgraph Deployment_Metrics[Deployment Metrics]
...
```mermaid
graph LR
    subgraph Configuration_Lifecycle[Configuration Lifecycle]
    ...
    %% Configuration types
    subgraph Configuration_Types[Configuration Types]
...
graph TB
    subgraph Monitoring_Architecture[Monitoring Architecture]
        subgraph Data_Collection__Edge[Data Collection (Edge)]
        ...
        subgraph Alerting_System[Alerting System]
...
```mermaid
graph LR
    subgraph Service_Level_Indicators[Service Level Indicators]
...
graph TB
    ...
    subgraph Response_Times__SLA[Response Times (SLA)]
...
```mermaid
graph TB
    subgraph Chaos_Engineering_Program[Chaos Engineering Program]
        subgraph Failure_Injection[Failure Injection]
        ...
        subgraph Blast_Radius_Testing[Blast Radius Testing]
        ...
        subgraph Automated_Recovery[Automated Recovery]
...
```mermaid
graph TB
    subgraph Global_Operations_Centers[Global Operations Centers]
        subgraph San_Francisco__Primary[San Francisco (Primary)]
        ...
        subgraph London__EMEA[London (EMEA)]
        ...
        subgraph Singapore__APAC[Singapore (APAC)]
